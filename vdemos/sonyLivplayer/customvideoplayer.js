...
options.subtitlesContent ='<div id="subtitles" class="vjs-subtitlesContent" style="display:none;"><div class="opt-1"><h3>Subtitles</h3><p>None <span>&check;</span></p></div><div class="opt-2"><h3>Audio and Language</h3><p>Hindi <span>&check;</span></p></div></div>';
options.qualityContent ='<div id="quality" class="vjs-qualityContent" style="display:none;"><h3 class="heading">Video Quality</h3><ol><li>Auto<span>&check;</span></li><li>High</li><li>Good</li><li>Data Saver</li></ol></div>';
